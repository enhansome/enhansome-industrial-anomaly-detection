...
[\[Main Page\]](https://github.com/M-3LAB) [\[Survey\]](https://github.com/M-3LAB/awesome-industrial-anomaly-detection) ⭐ 3,747 | 🐛 1 | 📅 2026-08-21 [\[Benchmark\]](https://github.com/M-3LAB/open-iad) ⭐ 172 | 🐛 3 | 🌐 Python | 📅 2025-02-20 [\[Result\]](https://github.com/M-3LAB/IM-IAD) ⭐ 25 | 🐛 0 | 📅 2023-07-04

🔥🔥🔥 Contributions to our repository are welcome. Feel free to categorize the papers and [pull requests](https://github.com/M-3LAB/awesome-industrial-anomaly-detection/pulls) ⭐ 3,747 | 🐛 1 | 📅 2026-08-21.
...
* CMDS-AD: Cross-Modal Dual-Stream Decoupling for Few-Shot Anomaly Detection [\[ECCV 2026\]](https://arxiv.org/abs/2606.20300)[\[code\]](https://github.com/Junhaocai27/CMDS-AD) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-08-26
...
* CostFilter-AD: Enhancing Anomaly Detection through Matching Cost Filtering [\[ICML2025\]](https://openreview.net/pdf?id=6p2wsBeYSs)[\[code\]](https://github.com/ZHE-SAPI/CostFilter-AD) ⭐ 92 | 🐛 1 | 🌐 Python | 📅 2026-07-03
...
* Anomalib: A Deep Learning Library for Anomaly Detection [\[ICIP 2022\]](https://ieeexplore.ieee.org/abstract/document/9897283/)[\[code\]](https://github.com/open-edge-platform/anomalib) ⭐ 6,091 | 🐛 77 | 🌐 Python | 📅 2026-08-27
...
* Towards total recall in industrial anomaly detection[\[CVPR 2022\]](http://arxiv.org/pdf/2106.08265)[\[code\]](https://github.com/amazon-science/patchcore-inspection) ⭐ 1,374 | 🐛 82 | 🌐 Python | 📅 2024-07-10
...
* Few-shot defect image generation via defect-aware feature manipulation [\[AAAI 2023\]](https://arxiv.org/abs/2303.02389)[\[code\]](https://github.com/Ldhlwh/DFMGAN) ⭐ 157 | 🐛 5 | 🌐 Python | 📅 2024-12-19
...
* MuSc-V2: Zero-Shot Multimodal Industrial Anomaly Classification and Segmentation with Mutual Scoring of Unlabeled Samples [\[TPAMI 2026\]](https://arxiv.org/abs/2511.10047)[\[code\]](https://github.com/HUST-SLOW/MuSc-V2) ⭐ 337 | 🐛 2 | 🌐 Python | 📅 2026-05-14
...
* Unified Unsupervised Anomaly Detection via Matching Cost Filtering [\[2025\]](https://arxiv.org/abs/2510.03363)[\[code\]](https://github.com/ZHE-SAPI/CostFilter-AD) ⭐ 92 | 🐛 1 | 🌐 Python | 📅 2026-07-03
* UniADC: A Unified Framework for Anomaly Detection and Classification [\[2025\]](https://arxiv.org/abs/2511.06644)[\[code is comming\]](https://github.com/cnulab/UniADC) ⭐ 33 | 🐛 2 | 🌐 Python | 📅 2026-06-30
